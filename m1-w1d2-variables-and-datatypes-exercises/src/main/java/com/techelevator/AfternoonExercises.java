...
public class AfternoonExercises {
	...
	public static void main(String[] args) {
        ...
        */
			...
			int flowersAndBees = 5 - 3;
			System.out.println(flowersAndBees);
        ...
        */
			int homeBeavers = 2 - 1;
			System.out.println(homeBeavers);
        ...
        */
        ...
        are there than nuts? 
        */
			int squirrelsAndNuts = 4 - 2;
			System.out.println(squirrelsAndNuts);
        ...
        */
			...
			float dime = .10f;
			float nickel = .05f;
			System.out.println(quarter + dime + nickel * 2);
        ...
        */
			...
			int macAdam = 20;
			int flannery = 17;
			System.out.println(brier + macAdam + flannery);
        ...
        */
			float hiltYoyo = .24f;
			float hiltWhistle = .14f;
			System.out.println(hiltYoyo + hiltWhistle);
        ...
        altogether?
        */
			int marshmellowLarge = 8;
			int marshmellowMini = 10;
			System.out.println(marshmellowLarge + marshmellowMini);
        ...
        */
			int houseSnow = 29;
			int schoolSnow = 17;
			System.out.println(houseSnow - schoolSnow);
        ...
        */
			...
			int toyTruck = 3;
			int pencilCase = 2;
			System.out.println(hilt - toyTruck - pencilCase);
        ...
        */
			int seaShellsInPossesion = 19;
			int seaShellsNeeded = 25;
			System.out.println(seaShellsNeeded - seaShellsInPossesion);
        ...
        */
           int beeLegs = 6;
           int bees = 8;
           System.out.println(beeLegs * bees);
        ...
        */
        		...
        		System.out.println(butterFlyTotal - butterFlyOrange);
        			
        /*    
        29. Kate gave the clerk $1.00. Her candy cost 54 cents. How much change
        should Kate get back?
        */
        		float kateFunds = 1.00f;
        		kateFunds -= .54;
        		System.out.println(kateFunds);
        ...
        */
        		int boats = 5;
        		int peopleOnBoats = 3;
        		System.out.println(boats * peopleOnBoats);
        ...
        */
        		...
        		familyPictures /= 20;
        		System.out.println(familyPictures);
