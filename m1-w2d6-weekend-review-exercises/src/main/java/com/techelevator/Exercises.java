...
public class Exercises {
	 ...
	 * array contains all 0's. makeLast([4, 5, 6]) → [0, 0, 0, 0, 0, 6] makeLast([1,
	 * 2]) → [0, 0, 0, 2] makeLast([3]) → [0, 3]
	 */
	public int[] makeLast(int[] nums) {
		int[] lastElement = new int[nums.length * 2];
		lastElement[nums.length * 2 - 1] = nums[nums.length - 1];
		return lastElement;
	}
	 ...
	 * 4's. no14([1, 2, 3]) → true no14([1, 2, 3, 4]) → false no14([2, 3, 4]) → true
	 */
	 ...
	 * Note that a length-0 array is valid. (See also: FizzBuzz Code) fizzArray3(5,
	 * 10) → [5, 6, 7, 8, 9] fizzArray3(11, 18) → [11, 12, 13, 14, 15, 16, 17]
	 * fizzArray3(1, 3) → [1, 2]
	 */
	 ...
	 * one of the others. lessBy10(1, 7, 11) → true lessBy10(1, 7, 10) → false
	 ...
	 * 10. greenTicket(1, 2, 3) → 0 greenTicket(2, 2, 2) → 20 greenTicket(1, 1, 2) →
	 * 10
	 */
